...
def plot_decision_tree(clf, feature_names, class_names):
    ...
    export_graphviz(clf, out_file="C:/Users/hp/coursera/Applied Machine Learning in Python/Module 2 Supervised Machine Learning/adspy_temp.dot", feature_names=feature_names, class_names=class_names, filled = True, impurity = False)
    with open("C:/Users/hp/coursera/Applied Machine Learning in Python/Module 2 Supervised Machine Learning/adspy_temp.dot"
) as f:
        dot_graph = f.read()
